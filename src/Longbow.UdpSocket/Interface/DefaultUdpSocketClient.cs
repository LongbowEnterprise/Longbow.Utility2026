...
sealed class DefaultUdpSocketClient(IOptions<UdpSocketClientOptions> options) : IUdpSocketClient
{
    ...
    private readonly UdpSocketClientOptions _options = options.Value.CopyTo();
    ...
    /// <inheritdoc/>
    /// </summary>
    public UdpSocketClientOptions Options => _options;
    ...
    public async ValueTask<bool> ConnectAsync(IPEndPoint endPoint, CancellationToken token = default)
    {
        ...
        try
        {
            ...
            await Task.Run(() =>
            {
                _client = new(Options.LocalEndPoint);
