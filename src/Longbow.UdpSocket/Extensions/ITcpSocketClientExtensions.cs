...
/// <summary>
/// <see cref="IUdpSocketClient"/> 扩展方法类
/// </summary>
public static class ITcpSocketClientExtensions
{
    ...
    public static ValueTask<bool> SendAsync(this IUdpSocketClient client, string content, Encoding? encoding = null, CancellationToken token = default)
    {
    ...
    public static ValueTask<bool> ConnectAsync(this IUdpSocketClient client, string ipString, int port, CancellationToken token = default)
    {
    ...
    /// <returns></returns>
    public static async ValueTask<ReadOnlyMemory<byte>> ReceiveAsync(this IUdpSocketClient client, CancellationToken token = default)
    {
    ...
    public static void AddDataPackageAdapter(this IUdpSocketClient client, IDataPackageHandler handler, Func<ReadOnlyMemory<byte>, ValueTask> callback) => client.AddDataPackageAdapter(new DataPackageAdapter(handler), callback);
    ...
    public static void AddDataPackageAdapter(this IUdpSocketClient client, IDataPackageAdapter adapter, Func<ReadOnlyMemory<byte>, ValueTask> callback)
    {
    ...
    /// <summary>
    /// 移除 <see cref="IUdpSocketClient"/> 数据适配器及其对应的回调方法
    /// </summary>
    /// <param name="client"></param>
    /// <param name="callback"></param>
    public static void RemoveDataPackageAdapter(this IUdpSocketClient client, Func<ReadOnlyMemory<byte>, ValueTask> callback)
    {
    ...
    /// <param name="handler"></param>
    /// <param name="callback"></param>
    public static void AddDataPackageAdapter<TEntity>(this IUdpSocketClient client, IDataPackageHandler handler, Func<TEntity?, ValueTask> callback) => client.AddDataPackageAdapter(new DataPackageAdapter(handler), callback);
    ...
    /// <param name="callback"></param>
    public static void AddDataPackageAdapter<TEntity>(this IUdpSocketClient client, IDataPackageHandler handler, IDataConverter<TEntity> converter, Func<TEntity?, ValueTask> callback) => client.AddDataPackageAdapter(new DataPackageAdapter(handler), converter, callback);
    ...
    /// <param name="adapter"></param>
    /// <param name="callback"></param>
    public static void AddDataPackageAdapter<TEntity>(this IUdpSocketClient client, IDataPackageAdapter adapter, Func<TEntity?, ValueTask> callback)
    {
    ...
    /// <inheritdoc/>
    /// </summary>
    public static void AddDataPackageAdapter<TEntity>(this IUdpSocketClient client, IDataPackageAdapter adapter, IDataConverter<TEntity> converter, Func<TEntity?, ValueTask> callback)
    {
        async ValueTask Proxy(ReadOnlyMemory<byte> buffer)
        {
            // 将接收到的数据传递给 DataPackageAdapter 进行数据处理合规数据触发 ReceivedCallBack 回调
    ...
    /// <param name="client"></param>
    /// <param name="callback"></param>
    public static void RemoveDataPackageAdapter<TEntity>(this IUdpSocketClient client, Func<TEntity?, ValueTask> callback)
    {
